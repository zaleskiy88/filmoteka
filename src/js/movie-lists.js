...
const ModalMovie = (function () {
  ...
  function view() {
    return `
            <button class="button" id="add-watched" type="button" ${
              addWatchedBtnState.watched ? 'disabled' : ''
            } data-lng="${addWatchedBtnState.lngKey}">${
      addWatchedBtnState.text
    }</button>
            <button class="button" id="add-queue"  type="button" data-lng="${
              addQueueBtnState.lngKey
            }">${addQueueBtnState.text}</button>
        `;
  }
